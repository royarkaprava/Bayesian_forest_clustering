...
clusteringFP <- function(X, p_b=0.1, a0=0.1, b0=0.1, K=20, kappa = 1000, Total_itr = 10000, burn=5000, gamma =1, random_scan_n = 0){
  #K=20
  ...
  while(itr < Total_itr){
    ...
    BupC(B, B2inv, clslb, clsmem, b1,b, wl, sig, kappa, Xmu, random_scan_n)
    A <- getA(B)
